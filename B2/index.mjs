...
const questions = [
  {
    question: "If I ___ more time, I would take up a new hobby.",
    answers: ["have", "had", "will have", "having"],
    correct: "had",
  },
  {
    question: "By the time we arrived, the movie ___ .",
    answers: ["has started", "started", "had started", "was starting"],
    correct: "had started",
  },
  {
    question: "She suggested ___ to the museum on Sunday.",
    answers: ["go", "to go", "going", "gone"],
    correct: "going",
  },
  {
    question: "I wish I ___ harder for the exam.",
    answers: ["study", "studied", "had studied", "was studying"],
    correct: "had studied",
  },
  {
    question: "If it ___ tomorrow, we’ll stay home.",
    answers: ["rains", "rain", "rained", "is raining"],
    correct: "rains",
  },
  {
    question: "He denied ___ the vase.",
    answers: ["break", "to break", "breaking", "broken"],
    correct: "breaking",
  },
  {
    question: "We were made ___ in line for two hours.",
    answers: ["wait", "to wait", "waiting", "waited"],
    correct: "wait",
  },
  {
    question: "Neither the teacher nor the students ___ in the classroom.",
    answers: ["is", "are", "was", "were"],
    correct: "are",
  },
  {
    question: "She can’t stand ___ late.",
    answers: ["to be", "be", "being", "been"],
    correct: "being",
  },
  {
    question: "He apologized ___ being late.",
    answers: ["for", "about", "on", "at"],
    correct: "for",
  },
  {
    question: "I’d rather you ___ tell anyone about this.",
    answers: ["don’t", "didn’t", "won’t", "wouldn’t"],
    correct: "didn’t",
  },
  {
    question: "The company is said ___ bankrupt last year.",
    answers: ["to go", "to have gone", "going", "gone"],
    correct: "to have gone",
  },
  {
    question: "If only she ___ the truth earlier.",
    answers: ["knows", "knew", "had known", "known"],
    correct: "had known",
  },
  {
    question: "Despite ___ tired, he finished the report.",
    answers: ["being", "be", "been", "to be"],
    correct: "being",
  },
  {
    question: "The film was so boring that we ___ before it ended.",
    answers: ["leave", "left", "leaves", "leaving"],
    correct: "left",
  },
  {
    question: "It’s the first time I ___ sushi.",
    answers: ["eat", "ate", "have eaten", "eaten"],
    correct: "have eaten",
  },
  {
    question: "If you heat ice, it ___ .",
    answers: ["melt", "melts", "melting", "melted"],
    correct: "melts",
  },
  {
    question: "She promised she ___ me tomorrow.",
    answers: ["call", "will call", "would call", "called"],
    correct: "would call",
  },
  {
  ...
  {
    question: "The book, together with the notes, ___ on the table.",
    answers: ["is", "are", "were", "have"],
    correct: "is",
  },
];
